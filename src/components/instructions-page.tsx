...
const sections: InstructionSection[] = [
  ...
  },
  {
    ...
    body: "La colonna sinistra governa lo stato di lavoro. Da qui scegli lo scenario base, rinomini la simulazione, salvi una fotografia in libreria e importi o esporti JSON.",
    bullets: [
  ...
  },
  {
    ...
    eyebrow: "Offerenti",
    title: "Gestire operatori, lotti e partecipazioni",
    body: "Ogni offerente può partecipare a lotti singoli e combinatorie. La matrice di partecipazione decide quali offerte entrano nel calcolo.",
    bullets: [
      "Seleziona un offerente dalla lista prima di compilare tecnica o economica.",
      "Aggiungi un nuovo operatore con il pulsante `+` se vuoi simulare un concorrente ulteriore.",
      "Spunta solo i lotti che l'offerente presenta davvero nello scenario.",
      "Per una combinatoria, attiva anche entrambi i lotti singoli collegati.",
      "Le combinatorie disponibili sono `1+2`, `2+3`, `3+4` e `1+4`.",
    ],
    checks: ["Offerente selezionato", "Lotti singoli coerenti", "Combinatorie attivate solo dove ammissibili"],
  },
  {
  ...
  },
  {
    ...
    body: "La tab `Ottimizzazione offerta` parte dall'offerta corrente e cerca il miglior punteggio raggiungibile con concorrenti fermi. Il budget massimo è un vincolo facoltativo, non il punto di partenza.",
    bullets: [
      "Scegli `Lotto attivo` per ottimizzare solo il lotto selezionato.",
      "Scegli `Tutti i lotti attivi` per distribuire le mosse sulle offerte singole dell'offerente.",
      "Scegli `Scenario complessivo` per misurare il contributo dell'offerente nello scenario vincente simulato.",
      "`Tecnica + ribasso` confronta miglioramenti tecnici e maggiore ribasso.",
      "`Solo tecnica` esclude il ribasso e usa solo leve tecniche.",
      "Attiva `usa budget massimo` solo quando vuoi simulare un tetto di investimento o di minore ricavo.",
      "Compila costo unitario, step, massimo e base per le leve che vuoi rendere ottimizzabili.",
    ],
    checks: ["Obiettivo scelto", "Costi e massimali motivati", "Budget massimo attivato solo se serve", "Piano applicato dopo lettura di delta e costo"],
  },
  {

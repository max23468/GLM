...
const sections: InstructionSection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Usa i bottoni rapidi: `+` crea, `Salva`, `Duplica`, `Elimina` e `Importa`.",
      "L'opzione `Esporta tutti` salva in un file unico tutti gli scenari presenti con nome `scenari-glm-<totale>-<data>.json`.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Copia l'offerta tra lotti dal candidato attivo usando il pulsante copia nella riga Partecipazione: il lotto attivo viene incollato nel lotto scelto.",
      ...
      "Il lotto di lavoro si può selezionare solo se il concorrente partecipa a quel lotto.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Apri il singolo criterio per leggere fonte, note e analisi puntuale.",
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      "Leggi `PEF, CEA e stress All. 18` per stimare margine dopo costi puntuali, fase prevalente, I_CEA e impatto di piccoli ribassi aggiuntivi.",
    ],
    checks: ["Tre fasi compilate", "Ribasso medio confrontato con Rmax", "€/km e stress letti come controlli gestionali, non come nuove formule"],
  },
  {
  ...
  },
  {
    ...
    bullets: [
      ...
      "Il reset totale cancella workspace, libreria, scenari base nascosti e preferenze locali, poi riparte dallo stato iniziale.",
      "I link alle fonti pubbliche aprono siti esterni solo quando vengono cliccati.",
    ],
    checks: ["Export creato per scenari importanti", "Reset usato solo dopo conferma", "Fonti esterne verificate manualmente se servono dati aggiornati"],
  },
];

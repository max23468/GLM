...
const sections: InstructionSection[] = [
  ...
  },
  {
    ...
    body: "La tab `Ottimizzazione` parte dall'offerta corrente e cerca il miglior punteggio raggiungibile con concorrenti fermi. Il budget massimo è un vincolo facoltativo, non il punto di partenza.",
    bullets: [
      ...
      "`Tecnica + ribasso` confronta miglioramenti tecnici, ribasso diretto e riallocazioni da tecnica a ribasso.",
      ...
      "Se una rinuncia tecnica libera risorse e il saldo netto è positivo, il piano mostra quanti punti tecnici perdi e quanti punti economici guadagni.",

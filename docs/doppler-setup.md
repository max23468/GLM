...
## Stato attuale repo
- `DOPPLER_PROJECT` impostato a: `GLM`
...
```bash
gh variable set DOPPLER_PROJECT --body "GLM" --repo max23468/GLM
gh variable set DOPPLER_CONFIG --body "production" --repo max23468/GLM

gh secret set DOPPLER_TOKEN --body "<service_token_read_only>" --repo max23468/GLM
```
